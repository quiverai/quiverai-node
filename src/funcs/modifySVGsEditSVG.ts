 ...
 */
export function modifySVGsEditSVG(
  client: QuiverAICore,
  _request: shared.EditSVGRequest,
...
> {
  ...
  >(
    ...
    M.json([400, 401, 429], operations.EditSVGResponse$inboundSchema),
    M.json(501, operations.EditSVGResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
